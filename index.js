...
miApp.get("/", (req, res) => {
    ...
    res.send(
        "<h1>API REST Productos La 80 - ES Modules</h1>"
    );
        ...
        try {
            ...
            if (
                ...
                return res.status(400).json({
                    ...
                    mensaje:
                        "Nombre, precio, stock y categoria son obligatorios"
            ...
            if (
                ...
                return res.status(400).json({
                    ...
                    mensaje:
                        "El stock debe ser un entero positivo o 0"
...
miApp.put(
    ...
    (req, res) => {
        ...
        try {
            ...
            let imagen =
                productos[posicion].imagen || null;
